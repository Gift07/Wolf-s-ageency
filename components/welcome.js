...
const Welcome = () => {
  return (
    <div className="w-full h-screen lg:h-[34rem] relative overflow-x-hidden">
      <div className="h-full w-full absolute z-20 background">
        <div
          data-aos="fade-up"
          className="pl-5 lg:pl-12 max-w-4xl pt-44 lg:pt-28"
        >
          <h1 className="uppercase text-md lg:text-sm text-orange-400 font-semibold">
            Demand more from your marketing?
          </h1>
          <h1 className="flex text-5xl lg:text-4xl  font-bold my-3 text-white">
            Grow your business presence, leads, calls, sells and revenue online.
          </h1>
          <h1 className="text-md lg:text-sm my-4 text-white">
          ...
          <div className=" my-5 lg:my-3">
            <button className=" flex gap-x-2 items-center text-md duration-200 hover:bg-sky-800 px-4 py-2 rounded-full bg-sky-600 text-white">
              Learn more
              <BsArrowRight />
            </button>
          </div>
