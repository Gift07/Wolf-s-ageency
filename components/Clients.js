            ...
            <div className='w-full h-full grid grid-cols-2 items-center justify-center'>
                <div className='h-full w-full pl-12 pr-2'>
                  ...
                  <div className='my-3 text-sm'>
                    <p>
                              Firstly, you tell us your goals and objectives to know what you want to achieve in short and long term before we get started.
                              Secondly, we discover about you, where are you strong?, where do you struggle? and then we compare with your goals and objectives.
                              Lastly, We build a strategy, now we turn the insights into actions. Youre on a right place please call us to get your free proposal.
