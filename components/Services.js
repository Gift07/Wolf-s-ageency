    ...
    <div className="w-full pb-5 overflow-x-hidden bg-gray-100">
      <div className="px-5 lg:px-12">
        <div className="my-4 pt-7">
          <h1 className="font-semibold text-sky-400 uppercase text-md">
            Our Services
          </h1>
        </div>
        <div className="my-3">
      ...
      <div className="px-12 pt-5 w-full flex items-center justify-center"></div>
      <div className="flex items-center justify-center">
        <div className="lg:grid lg:grid-cols-4 justify-center gap-x-4">
